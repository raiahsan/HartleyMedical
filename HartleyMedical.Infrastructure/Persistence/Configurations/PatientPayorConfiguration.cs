...
{
    public partial class PatientPayorConfiguration : IEntityTypeConfiguration<PatientPayor>
    {
        public void Configure(EntityTypeBuilder<PatientPayor> entity)
        {
            ...
            entity.Property(e => e.PolicyHolderDOB).HasColumnType("date");
        ...
        partial void OnConfigurePartial(EntityTypeBuilder<PatientPayor> entity);
    }
}
