...
{
    public partial class PayorConfiguration : IEntityTypeConfiguration<Payor>
    {
        public void Configure(EntityTypeBuilder<Payor> entity)
        {
            ...
            entity.Property(e => e.IsEDIPayer)
                .IsRequired()
                .HasDefaultValueSql("(CONVERT([bit],(0)))");

            entity.Property(e => e.IsSupportingClaims)
                .IsRequired()
                .HasDefaultValueSql("(CONVERT([bit],(0)))");

            entity.Property(e => e.IsSupportingEligibility)
                .IsRequired()
                .HasDefaultValueSql("(CONVERT([bit],(0)))");
        ...
        partial void OnConfigurePartial(EntityTypeBuilder<Payor> entity);
    }
}
